...
let project_folder = require("path").basename(__dirname); /* Instead of "let project_folder="dist;" */
...
function fontsStyle(params) {
    ...
    if (file_content == '') {
        fs.writeFile(source_folder + '/scss/global/_fonts.scss', '', cb);
            ...
            if (items) {
                ...
                fontname = fontname[0];
                    if (c_fontname != fontname) {
                        fs.appendFile(source_folder + '/scss/global/_fonts.scss', '@include font("' + fontname + '", "' + fontname + '", "400", "normal");\r\n', cb);
                    }
                    c_fontname = fontname;
                }
            }
